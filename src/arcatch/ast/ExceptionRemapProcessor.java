...
public class ExceptionRemapProcessor extends AbstractProcessor {
	private final ExceptionRemapScanner scanner;
	private Trees trees;

	public ExceptionRemapProcessor(final ExceptionRemapScanner scanner) {
